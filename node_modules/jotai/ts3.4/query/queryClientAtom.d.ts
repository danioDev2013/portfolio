...
export declare const queryClientAtom: import("jotai").Atom<QueryClient | null> & {
    write: import("../core/types").Write<import("../core/types").SetStateAction<QueryClient | null>>;
    onMount?: import("../core/types").OnMount<import("../core/types").SetStateAction<QueryClient | null>> | undefined;
